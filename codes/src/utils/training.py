...
from src.optim.srm_solver import PSGSRM, SmoothedLSVRG, Prospect, StochasticSubgradientMethod
...
def compute_training_curve(
    ...
    if (
        ...
        test_objective = get_objective(model_cfg, X_test, y_test, dataset=dataset)
